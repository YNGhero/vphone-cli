...
boot_gui() {
  ...
  vphone_vm_apply_network_config "${VM_DIR}/config.plist" "${NETWORK_MODE:-${VPHONE_NETWORK_MODE:-}}" "${NETWORK_INTERFACE:-${VPHONE_NETWORK_INTERFACE:-}}" "${VPHONE_MAC_ADDRESS:-${MAC_ADDRESS:-}}" \
