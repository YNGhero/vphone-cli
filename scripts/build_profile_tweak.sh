#!/bin/zsh
# Build VPhoneProfileTweak rootless iOS dylib.

set -euo pipefail
SCRIPT_DIR="${0:A:h}"
PROJECT_ROOT="${SCRIPT_DIR:h}"
SRC="${PROJECT_ROOT}/tweaks/vphone_profile_tweak/VPhoneProfileTweak.m"
OUT_DIR="${PROJECT_ROOT}/.build/vphone_profile_tweak"
OUT="${OUT_DIR}/VPhoneProfileTweak.dylib"
...
print -r -- "[*] building VPhoneProfileTweak"
"$CC" -isysroot "$SDK" \
